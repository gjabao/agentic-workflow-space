...
class GlassdoorJobScraper:
    # Actor IDs
    JOB_SCRAPER_ACTOR_ID = "agentx/glassdoor-hiring-scraper"  # Glassdoor Jobs Scraper
    ...
    MAX_WORKERS = int(os.getenv("MAX_WORKERS", "20"))  # Parallel workers
    ...
    def detect_company_type(self, company_name: str, industry: str = "", description: str = "") -> str:
        ...
        if any(word in text for word in ['consulting', 'accounting', 'legal', 'law', 'recruitment', 'staffing', 'hr ']):
